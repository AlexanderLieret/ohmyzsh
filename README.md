...
[![Merge upstream branches](https://github.com/AlexanderLieret/ohmyzsh/workflows/Merge%20upstream%20branches/badge.svg)](https://github.com/AlexanderLieret/ohmyzsh/actions?query=workflow%3A%22Merge+upstream+branches%22)
...
| Method    | Command                                                                                           |
|:----------|:--------------------------------------------------------------------------------------------------|
| **curl**  | `sh -c "$(curl -fsSL https://raw.githubusercontent.com/AlexanderLieret/ohmyzsh/master/tools/install.sh)"` |
| **wget**  | `sh -c "$(wget -O- https://raw.githubusercontent.com/AlexanderLieret/ohmyzsh/master/tools/install.sh)"`   |
| **fetch** | `sh -c "$(fetch -o - https://raw.githubusercontent.com/AlexanderLieret/ohmyzsh/master/tools/install.sh)"` |
...
```shell
wget https://raw.githubusercontent.com/AlexanderLieret/ohmyzsh/master/tools/install.sh
sh install.sh
```
